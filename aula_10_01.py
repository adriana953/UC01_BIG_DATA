...
plt.text(0.1,0.4,f'Distância entre a Variância e Média das Rendas {distancia_var_renda}',fontsize=12)
...
plt.text(0.1,0.8,f'Mediana dos Empréstimos {mediana_Vlr_emprestado}',fontsize=12)
plt.text(0.1,0.7,f'Distância entre Média e Mediana dos Empréstimos {distancia_Vlr_emprestado}',fontsize=12)
plt.text(0.1,0.6,f'Maior valor dos Empréstimos {maior_Vlr_emprestado}',fontsize=12)
plt.text(0.1,0.5,f'Menor valor dos Empréstimos {menor_Vlr_emprestado}',fontsize=12)
plt.text(0.1,0.4,f'Distância entre a Variância e Média dos Empréstimos {distancia_var_Vlr_emprestado}',fontsize=12)
plt.text(0.1,0.3,f'Coeficiente de variação dos Empréstimos {coeficiente_var_Vlr_emprestado}',fontsize=12)
